...
1. ```http://localhost:3000/products/```
   ![alt text](photo/first_req_products.png)

2. ```http://localhost:3000/products/3```
   ![alt text](photo/search_item.png)

3. ```http://localhost:3000/products/3```
   ![alt text](photo/Del_item.png)

### Задание 2
Выберите API (пример, Открытые API) и получите ключ. Изучите документацию и
выполните не менее 5-ти запросов.

1. ![alt text](photo/YandexWH/1-st.png)
2. ![alt text](photo/YandexWH/Ekt.png)
3. ![alt text](photo/YandexWH/Kalik.png)
4. ![alt text](photo/YandexWH/Kazan.png)
5. ![alt text](photo/YandexWH/Vladik.png)
